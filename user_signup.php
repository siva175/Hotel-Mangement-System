		...
		<form action="user_signed_up.php" method="post">
			<table>
				...
				<tr>
					...
					<td><input class="input" type="text" name="name" placeholder="Enter Name" required autocomplete="off"></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">Phone Number: </td>
					<td><input class="input" type="number" name="phone" placeholder="Enter Number" required autocomplete="off"></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">Password: </td>
					<td><input class="input" type="password" name="password" placeholder="Enter Password" required autocomplete="off"></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">Email ID: </td>
					<td><input class="input" type="email" name="email" placeholder="Enter Email" required autocomplete="off"></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">ID Proof: </td>
					<td><input class="input" type="text" name="idproof" placeholder="Enter ID Proof" required autocomplete="off"></td>
				</tr>
				<tr>
					<td style="padding-left: 60px; text-align: left;">Date of birth: </td>
					<td><input class="input" type="date" name="dob" value="01-01-2000" required autocomplete="off"></td>
				</tr>
				<tr><td><br></td></tr>
				<tr>
