	...
	<form action="admin_db.php" method="post">
		<table>
			...
			<tr>
				...
				<td><input class="input" type="text" name="adminid" placeholder="Enter user ID" value="" required autocomplete="off"></td>
			</tr>
			<tr>
				<td style="padding-left: 20px;">Password:</td>
				<td><input class="input" type="password" name="password"  placeholder="Enter password" value="" required autocomplete="off"></td>
			</tr>
			<tr><td><br></td></tr>
			<tr>
