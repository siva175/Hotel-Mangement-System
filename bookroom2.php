...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<td id="td1" style="padding: 10px; font-size: 48px;">THE <p style="color: #e6b800; font-size: 48px; display: inline;">ROYLE</p> HOTEL</td>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p>Room Booking is successfully Booked!!!</p>
